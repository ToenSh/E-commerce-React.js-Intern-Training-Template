    ...
    <Accordion type="single" collapsible className="text-dark-green mt-4">
      <AccordionItem value="item-1">
        ...
        <AccordionContent className="opacity-75 pl-4 tracking-wider text-base font-normal flex flex-col gap-4">
          <p>
            The nylon upper is made from repurposed marine plastic collected by
            fishermen globally.{' '}
          </p>
      ...
      <AccordionItem value="item-2">
        ...
        <AccordionContent className="opacity-75 pl-4 tracking-wider text-base font-normal flex flex-col gap-4">
          ...
          <p>
            Vibram Sole: Durable, made to endure ice and snow, comfortable, made
            for longevity.
          </p>
          <p>Waterproof: yes</p>
      ...
      <AccordionItem value="item-4">
        ...
        <AccordionContent className="opacity-75 pl-4 tracking-wider text-base font-normal flex flex-col gap-4">
          Easy returns in North America as many times as you need to find the
          right size. Just contact our team for support!
        </AccordionContent>
      </AccordionItem>
