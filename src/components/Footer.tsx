...
import tiktokLogo from '../assets/icons/social/tiktok.svg';
import facebookLogo from '../assets/icons/social/facebook-f.svg';
const Footer = () => {
  return (
    <footer className="bg-dark-green">
      <div className="max-w-7xl mx-auto flex items-start gap-4 py-10">
        <div className="flex flex-col gap-6 basis-1/4">
          ...
          <h2 className="font-semibold text-lg text-white max-w-xs">
          ...
          <div className="flex items-center gap-6">
            ...
            <img
              src={facebookLogo}
              alt="facebook"
              className="w-3 cursor-pointer hover:scale-105"
            />
            <img
              src={twitterLogo}
              alt="twitter"
        ...
        <div className="flex basis-3/4 gap-24">
          <nav className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-3">
              <li className="text-white opacity-75 text-sm hover:underline hover:opacity-100 cursor-pointer">
                All Products
              </li>
              <li className="text-white opacity-75 text-sm hover:underline hover:opacity-100 cursor-pointer">
                The Weekend Boot
